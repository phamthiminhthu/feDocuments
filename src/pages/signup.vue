        ...
        <div class="grid grid-cols-1 gap-1 justify-items-center items-center md:grid-cols-2">
            ...
            <div class="form-login justify-center w-3/4">
                ...
                <div class="landing-font-44 mt-6 text-center">
                    Welcome to
                    <span class="text-amber-700 font-bold italic leading-[72px]">Docskanry</span> !
                </div>
                <form @submit="registerForm">
                    <div class="mt-20">
                        ...
                        <div class="flex rounded-md mt-2">
                            <v-text-field id="email" v-model="email" :rules="emailRules" type="email" outlined dense
                                required
                                class="block flex-1 border-0 bg-transparent py-3 pl-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 invalid:border-pink-500 invalid:text-pink-600  "></v-text-field>
                        </div>
                        <label for="username"
                            class="block text-sm font-medium landing-font-18 text-gray-900 mt-5">Username</label>
                        <div class="flex rounded-md mt-2">
                            <v-text-field id="username" v-model="username" :rules="usernameRules" type="text" outlined dense
                                required
                                class="block flex-1 border-0 bg-transparent py-3 pl-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 invalid:border-pink-500 invalid:text-pink-600  "></v-text-field>

                        </div>
                        <label for="password"
                            class="block text-sm font-medium landing-font-18 text-gray-900 mt-5">Password</label>
                        <div class="flex rounded-md mt-2">
                            <v-text-field id="password" v-model="password" :rules="passwordRules" type="password" outlined
                                dense required
                        ...
                        <label for="confirm-password"
                            class="block text-sm font-medium landing-font-18 text-gray-900 mt-5">Confirm Password</label>
                        <div class="flex rounded-md mt-2">
                            <v-text-field id="confirm-password" v-model="confirmPassword"
                                :rules="confirmPasswordRules.concat(passwordConfirmationRule)" type="password" outlined
                                dense required
                                class="block flex-1 border-0 bg-transparent py-3 pl-2
                                                      text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6"></v-text-field>
                        </div>
                        <div class="mt-20">
                            <button type="submit"
                        ...
                        <div class="text-base mt-10 text-center">
                            ...
                            <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">Login
                            </a>
                        </div>
                    </div>
                </form>
