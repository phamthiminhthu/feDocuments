    ...
    <div class="">
      ...
      >
        <div class="logo w-full h-screen md:block hidden">
          <img
            src="~/assets/image/login/bg-login.png"
            ...
            <div class="mt-20">
              ...
              <div class="flex rounded-md mt-2">
                <v-text-field
                  ...
                  dense
                  required
                  class="block flex-1 border-0 bg-transparent py-3 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 invalid:border-pink-500 invalid:text-pink-600"
                ></v-text-field>
              </div>
              <label
                for="password"
              ...
              <div>
                <button
                  type="submit"
                  class="group relative flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 font-semibold !text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  <span
